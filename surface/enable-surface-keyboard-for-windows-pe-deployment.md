...
1. 從適當的位置下載最新的 Surface 膝上型電腦 MSI 檔案：
    - [Surface 膝上型電腦 (1 Gen) 驅動程式和固件](https://www.microsoft.com/download/details.aspx?id=55489)
...
2. 將 Surface 膝上型電腦 MSI 檔案的內容解壓至資料夾，您可以輕鬆地找到 (例如 c：\ surface_laptop_drivers) 。 若要解壓縮內容，請開啟提升許可權的命令提示字元視窗，然後執行下列範例中的命令：
