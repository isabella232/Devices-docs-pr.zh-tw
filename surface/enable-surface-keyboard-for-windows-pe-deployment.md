...
>
> - 按住 Power 按鈕 30 秒。 如果您連接到電源裝置 (PSU) ，請按住電源按鈕，直到您看到 PSU 電源線結尾的燈短暫關閉，然後再重新開啟。

> [!IMPORTANT]
> 如果您要將 Windows 10 映射部署到預先安裝 S 模式 Windows 10 的 Surface Laptop，請參閱 KB [4032347，](https://support.microsoft.com/help/4032347/surface-preinstall-windows10-s-mode-issues)將 Windows 部署到在 S 模式中預先安裝 Windows 10 的 Surface 裝置時的問題。
...
2. 將檔案內容解壓縮Surface Laptop .msi到一個資料夾，您可以輕鬆找到 (例如 c：\surface_laptop_drivers) 。 若要解壓縮內容，請開啟提升的 Command Prompt 視窗，然後從下列範例執行命令：
