...
ms.locfileid: "12096461"
---
# <a name="whats-new-in-surface-dock-2"></a>Surface Dock 2 的新增功能

Surface Dock 2 是下一代的 Surface Dock，可讓使用者連接外部監視器和多個周邊裝置，以從 Surface 裝置取得完全現代化的桌面體驗。 Surface Dock 2 是專為在辦公室、彈性工作區或家中最大化效率所打造，擁有七個埠，包括兩個前置 USB-C 埠，以及 15 瓦的手機和配件快速充電電源。

### <a name="full-device-management-support"></a>完整的裝置管理支援

Surface Dock 2 是專為簡化 IT 管理所設計，讓系統管理員能夠使用內部軟體發佈工具Windows更新或集中更新來自動化固件更新。
...
- **無摩擦更新**。 使用 Windows 更新或 Microsoft Endpoint Configuration Manager，以 (System Center Configuration Manager - SCCM) 或其他 MSI 部署工具，以無提示) 方式更新您的 dock。
