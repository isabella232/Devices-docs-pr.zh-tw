...
ms.locfileid: "11470491"
---
# <a name="install-and-mount-surface-hub-2s-85"></a>安裝和安裝 Surface Hub 2S 85"

本文提供在商業環境中實際安裝 Microsoft Surface Hub 2S 85" 的支援指南。 
...
> [!WARNING]
> **處理和網站準備**<br>
> - 裝置非常重。 若要降低因裝置大小與重量而造成個人傷亡、死亡或損毀的風險，請保持裝置直立。
>- 在將裝置移至安裝位置之前，請調查網站，以決定如何安全地將裝置移至將裝置解壓縮並裝載的位置。
>- 請至少使用兩個人來解壓縮和安裝。
...
4. 移除蓋，然後解除並移除前後面板。
 ...
 ![移除外部包裝](images/hub85mount1a.png) <br>
...
2. 移除黑色中心泡泡支援。
 ...
 ![移除黑色外包裝泡泡](images/hub85mount2a.png) <br>

> [!Caution]
> 請勿移除任何白色泡泡、帶狀或包裝材料，直到 Hub 2S 與放置該容器的購物車或牆面安裝座相鄰。
其他系帶材料會放在封裝背面的手式螺旋式按鈕下的小方塊中。 在移動之前，尤其是旋轉裝置及其保護套件之前，必須先放置原始或取代的系帶材料
...
> [!TIP]
> 轉輪式貨盤可自訂配合內部框架包裝的封裝封裝，並可用於整個安裝網站傳遞程式。 內木框架端部有鋼制滑板。
...
3. 將產品移至牆面或購物車安裝的位置。
 ...
 ![將 Surface Hub 85" 放回貨盤](images/hub85mount6a.png) <br>

## <a name="7-place-surface-hub-85-on-wall-mount-or-cart"></a>7. 將 Surface Hub 85" 放在牆面安裝或購物車
...
9. 使用木材基座上的四個手用按鈕釘移除木端部分。
   ...
   ![將 Surface Hub 85" 放在牆面安裝或購物車](images/hub85mount7a.png) <br>
...
Surface Hub 2S 85" 使用 600 x 600 VESA 安裝模式。 如下圖所示，Microsoft 已與 [Steelcase](https://www.steelcase.com/products/collaboration/steelcase-roam/) 合作，建立與 Surface Hub 2S 85" 獨特設計相容的安裝選項。 

![鋼箱牆體安裝](images/sh2-steelcasemount.png) <br>
...
![Surface Hub 85" 尺寸詳細資料以安裝](images/sh2-85-measure2.png) <br>

![Surface Hub 85" 尺寸可安裝](images/sh2-85-measure1.png) <br>


## <a name="supplemental-strapping-kit"></a>補充系帶套件

附加于右下角的套件中，有一組額外的內包裝系帶材料。
...
>- 確保建議的安裝系統支援此裝置重量。
>- 只能使用安裝系統時所提供的安裝硬體。
>- 請依照製造商的指示，確保所有的螺絲都安全地固定。
>- 在裝置與安裝系統附件點完全連接之前，請勿放開裝置。
...
因不當使用或不當使用裝置而造成觸控式螢幕開裂或切開，不在產品有限保固範圍內。

> [!WARNING]
>  **正確安裝**<br>
為了避免與裝置安裝不當相關的危險，安裝必須由在開始作業前閱讀並瞭解安裝指示的人執行。 如果您沒有必要的設備或專業知識，或是不確定安裝表面是否可正確支援，請詢問專業安裝程式。
