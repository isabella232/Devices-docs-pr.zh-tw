...
為確保裝置在上班時間一律可以使用，Surface Hub 會在指定的維護期間執行其管理功能。 在維護期間，Surface Hub 會透過 Windows Update 或 WSUS 自動安裝更新，並在需要時將裝置重新開機。
...
- [博客文章：服務、正式及管理 Surface Hub （當然就是 Intune）的更新](https://blogs.technet.microsoft.com/y0av/2018/05/31/7-3/)
